...
# create .rvmrc file with the following code:

rvm ree-1.8.7-2012.02@pha --create


# downgrade rubygems

gem update --system 1.8.25 (Kuba: I had to do it)
...
Password to all accounts: stuart eg. stuart/fmetrics1017
...
Please reaload db afterwards as zip file contains only couple sample codes

# Staging configuration

- Add secret before_bundle.rb to deploy folder with following commands ( deploy folder is located in project dir )
...
- Add secret key to secrets.yml file on QA server ( shared folder )
