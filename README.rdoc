...
- Add secret key to secrets.yml file on QA server ( shared folder ).  Use same rollbar key for all environments.  Use unique key for devise for each environment.

staging:
  rollbar_key_base: 8eeeb09ec76d2442a745fea6cc48a2cf
