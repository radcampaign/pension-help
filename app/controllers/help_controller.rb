...
class HelpController < ApplicationController
  ...
  def update_session
    puts "------------>"
    puts "Storing"
    puts @counseling.to_yaml
    session[:counseling] = @counseling.to_yaml
  end
  ...
  def current_counseling
    unless @counseling
      ...
      Counseling.class
      @counseling  = session[:counseling] ? YAML.load(session[:counseling]) : Counseling.new
      puts "<------------"
      puts "Loaded"
      puts @counseling.to_yaml
    end
  ...
  def counseling_params
    params.require(:counseling).permit(
        :zipcode,
        :employment_start,
        :employment_end,
        :is_divorce_related,
